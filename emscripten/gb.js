...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'gb.wast';
  var wasmBinaryFile = 'gb.wasm';
  var asmjsCodeFile = 'gb.temp.asm.js';
...
// {{PRE_LIBRARY}}
  ...
  function _glDrawPixels(
  ) {
  err('missing function: glDrawPixels'); abort(-1);
  }
  ...
  function _glPixelZoom(
  ) {
  err('missing function: glPixelZoom'); abort(-1);
  }

  function _glRasterPos2i(
  ) {
  err('missing function: glRasterPos2i'); abort(-1);
  }
...
Module['wasmTableSize'] = 39680;

Module['wasmMaxTableSize'] = 39680;
